...
* **Metrics review:** by reviewing metrics, we can get useful information about how users use our product. Then, we can use this information to iterate over it. It’s important to invest in good tools and standardize how we add metrics to our product. Otherwise, it’s difficult to access relevant information.

...
* [Iterative and Incremental Development: we need both](https://productdeveloper.net/iterative-incremental-development/): iterative and incremental are different ideas with different purposes. This article shows the differences between these ideas and how we usually apply them.
